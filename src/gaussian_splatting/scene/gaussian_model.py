...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd: BasicPointCloud, cam_infos: int = None, spatial_lr_scale: float = 1):
    ...
    def update_learning_rate(self, iteration):
        ...
        if self._exposure is not None and self.pretrained_exposures is None:
